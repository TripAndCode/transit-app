...
export function StopPatternResult({ messageId, points, onFocus }: {
  ...
  return <>
    ...
    <StopEvidenceChart key={`${messageId}:${patternId}`} messageId={messageId} points={visible} onFocus={onFocus} complete />
  </>;
}
