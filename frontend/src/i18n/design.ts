export const design = {
  ja: {
    ...
    observed: "観測便 {{count}}便", delayed: "5分以上の遅延 {{count}}便", attention: "確認したい便",
  ...
  en: {
    ...
    observed: "{{count}} observed trips", delayed: "{{count}} trips delayed 5+ minutes", attention: "Trips to check",
