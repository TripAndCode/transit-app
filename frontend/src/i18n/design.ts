export const design = {
  ja: {
    ...
    csv: "CSVダウンロード", exportFailed: "ダウンロードできませんでした。再度お試しください。",
    empty: "この条件の観測データはありません", choose: "路線と系統を選んでください",
    observed: "観測便 {{count}}便", delayed: "5分以上の遅延 {{count}}便", attention: "確認したい便", onTimePct: "定時運行率",
    observedLabel: "観測便", delayedLabel: "5分以上の遅延", resizeQueue: "パネルの幅を変更",
    openAnalysis: "この系統を分析 →", allObserved: "観測便を確認", noDelayed: "この条件で5分以上の遅延は観測されていません",
    stale: "受信が途絶えています。表示は過去の観測です。", status: "データの状態",
    ...
    tabMap: "地図", tabTrend: "遅延の推移", tabByStop: "停留所別",
  ...
  en: {
    ...
    csv: "Download CSV", exportFailed: "Download failed. Please try again.",
    empty: "No observations match these filters", choose: "Choose a route and service pattern",
    observed: "{{count}} observed trips", delayed: "{{count}} trips delayed 5+ minutes", attention: "Trips to check", onTimePct: "On-time rate",
    observedLabel: "Observed", delayedLabel: "Delayed 5+ min", resizeQueue: "Resize panel",
    openAnalysis: "Analyze this pattern →", allObserved: "View observed trips", noDelayed: "No delays of 5+ minutes observed for these filters",
    stale: "Reception has stopped. These are historical observations.", status: "Data status",
    ...
    tabMap: "Map", tabTrend: "Delay trend", tabByStop: "By stop",
