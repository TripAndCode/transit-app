export const design = {
  ja: {
    ...
    mareyChartLabel: "ダイヤ図：{{from}}–{{to}} の {{n}} 便。同じ内容を下の表にも掲載しています。",
    mareyTripLabel: "{{departure}} 発、{{first}} から {{last}}、終点の遅延 {{delay}} 分",
    mareyTableCaption: "便ごとの運行区間と終点の遅延",
    mareyFirstStop: "始発停留所", mareyLastStop: "終着停留所",
    mareyShowChart: "図を表示", mareyHideChart: "図を隠す",
  ...
  en: {
    ...
    mareyShowChart: "Show diagram", mareyHideChart: "Hide diagram",
