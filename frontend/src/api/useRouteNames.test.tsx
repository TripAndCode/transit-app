...
// complementary to the plain-renderHook tests above of the `format()`
// fallback order (route_short_name -> route_long_name -> route_id -> bare-
// code fallback), which don't need JSX.
