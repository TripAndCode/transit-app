...
export function AdminBoardPage() {
  ...
  return (
    <div style={{ padding: 24, display: "grid", gap: 16, alignContent: "start" }}>
      ...
      >
        <h2 id="board-reanalyze-confirm-title" style={{ fontSize: 13, fontWeight: 700, margin: 0 }}>
          {t("admin.board.reanalyze_confirm_title")}
        </h2>
        <p style={{ margin: 0, fontSize: 12.5, color: "var(--text-secondary)" }}>{t("admin.board.reanalyze_confirm_body")}</p>
