...
_WEIGHTED_BY_AGENCY_SQL, exercised against a real DB in
...
def test_pct_divides_and_rounds_to_one_decimal():
    # 910/1100*100 = 82.7272... -> 82.7 (not a .x5 tie, so this doesn't
    # distinguish round-half-up from _pct's actual round-half-to-even)
